...
<div class="container">
        <h4 style="margin: 0;float: left;" id="head"><!-- SEMESTER WILL GO HERE --></h4>
        <br>
        ...
        <div class="table-responsive" style="overflow-y:auto; max-height: 73%">
            <table class="table table-bordred table-striped" id="sectionstudentinfo">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>ID</th>
                              ...
                              <!-- MODAL BODY -->
                                    <div class="container">
                                        ...
                                        <div id="rslt" class="tab-pane fade in active rslt" style="max-height:55%;overflow-y: auto; background:white;margin-top:5px;">
                                            <div class="frst">
                                                <div class="bdy" style="border: none;border-bottom: 1px solid grey;width: 70%;">
                                                ...
                                                <div class="collapse" id="frsttable">
                                                    <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="firstresulttable">
                                                        <thead>
                                                        <tr class="resulttr">
                                                            <th>Subject</th>
                                                            <th>Attendance</th>
                                            ...
                                            <div class="scnd">
                                                ...
                                                <div class="collapse" id="scndtable">
                                                        <!-- TABLE SEMESTER DATA -->
                                                        <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="scndresulttable">
                                                                <thead>
                                                                <tr class="resulttr">
                                                                    <th>Subject</th>
                                                                    <th>Attendance</th>
                                                ...
                                                <div class="thrd">
                                                        ...
                                                        <div class="collapse" id="thrdtable">
                                                                <!-- TABLE SEMESTER DATA -->
                                                                <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="thrdresulttable">
                                                                        <thead>
                                                                        <tr class="resulttr">
                                                                            <th>Subject</th>
                                                                            <th>Attendance</th>
                                                    ...
                                                    <div class="frth">
                                                            ...
                                                            <div class="collapse" id="frthtable">
                                                                    <!-- TABLE SEMESTER DATA -->
                                                                    <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="frthresulttable">
                                                                            <thead>
                                                                            <tr class="resulttr">
                                                                                <th>Subject</th>
                                                                                <th>Attendance</th>
                                                    ...
                                                    <div class="ffth">
                                                            ...
                                                            <div class="collapse" id="ffthtable">
                                                                    <!-- TABLE SEMESTER DATA -->
                                                                    <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="ffthresulttable">
                                                                    <thead>
                                                                    <tr class="resulttr">
                                                                        <th>Subject</th>
                                                                        <th>Attendance</th>
                                                        ...
                                                        <div class="sxth">
                                                                ...
                                                                <div class="collapse" id="sxthtable">
                                                                        <!-- TABLE SEMESTER DATA -->
                                                                        <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="sxthresulttable">
                                                                        <thead>
                                                                        <tr class="resulttr">
                                                                            <th>Subject</th>
                                                                            <th>Attendance</th>
                                                            ...
                                                            <div class="svnth">
                                                                    ...
                                                                    <div class="collapse" id="svnthtable">
                                                                            <!-- TABLE SEMESTER DATA -->
                                                                            <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="svnthresulttable">
                                                                            <thead>
                                                                            <tr class="resulttr">
                                                                                <th>Subject</th>
                                                                                <th>Attendance</th>
                                                                ...
                                                                <div class="eghth">
                                                                        ...
                                                                        <div class="collapse" id="eghthtable">
                                                                                <!-- TABLE SEMESTER DATA -->
                                                                                <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="eghthresulttable">
                                                                                <thead>
                                                                                <tr class="resulttr">
                                                                                    <th>Subject</th>
                                                                                    <th>Attendance</th>
                                        ...
                                        <div id="rtkrcrse" class="tab-pane fade rtkrcrse" style="background:white">
                                                <table class="table table-striped" style="width:60%; border: 1px solid grey;margin-top: 5px;margin-left: 45px;" id="rtktable">
                                                        <thead>
                                                        <tr class="resulttr">
                                                            <th>Subject</th>
                                                            <th>Semester</th>
             ...
             success:function(data)
             {
                 if(data['nosession'] === false)
                 {
                    if(data['success'] === true)
                    {
                        ...
                        {
                            list = list+"<li onclick='showlist("+sectionlist[i].id+")' style='cursor:pointer'><a>"+sectionlist[i].name+"</a></li>"
                        }
