...
@endif
<div class="container">
    <div id="msg" style="float: left;display: none;">@if($error) <div class="alert alert-danger">{{$error}}</div>@endif</div>
    ...
    <!-- MODAL CONTENT FOR ADDING SEMESTER AHEAD -->
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="usr">Add semester name:</label>
                            <input type="number" class="form-control" id="sems" name="semester_name" required
            ...
            <!-- ERROR MESSAGE FOR DISPLAYING USER DIDNT SELECT ANY SEMESTER -->
            <script>
...
function setbutton(id,active)
{
    if(active === 1)
    {
        return '<button class="btn btn-danger" onclick="enabledisable('+id+',1)">Disable</button>';
    }
    else
    {
