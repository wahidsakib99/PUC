            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    @for ( $i= 0; $i < count($datas); $i++)
                        <tr>
                        <td class="col-md-9"><em>{{$datas[$i]->subname}}</em></h4></td>
                            <td class="col-md-1" style="text-align: center"> @if($datas[$i]->type == 0)Regular @elseif($datas[$i]->type == 1)Retake @elseif($datas[$i]->type == 2) Recourse @endif </td>
