        ...
        <div class="col-xs-12 col-md-4">
            <div class="panel panel-default">
                ...
                <form role="form" action="/student/payment/post/{{$total}}" method="post">
                    ...
                    @if ($errors->has('ycardNumber'))<p style="color:red">@foreach($errors->get('ycardNumber') as $e){{$e}}<br>@endforeach</p>@endif
                </div>
            </div>
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><span class="badge pull-right"><span class="glyphicon glyphicon-taka"></span>{{$total.'/='}}</span> Final Payment</a>
                </li>
            </ul>
            <br/>
