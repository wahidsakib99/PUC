...
class studentpaymentcontroller extends Controller
{
    ...
    public function index()
    {
        ...
        if($active_session)
        {
            ...
            {
                $paid = true;
                return view('student.reciept')->with('datas',$datas)->with('profile',$profile)->with('advisor_name',$advisor_name)->with('sub_value',$sub_value)->with('total',$total)->with('error',$error)->with('secname',$user_section)->with('session',$active_session)->with('paid',$paid)->with('payment_data',$previous_paid);
            }
            else
            {
                $paid = false;
            }
                return view('student.reciept')->with('datas',$datas)->with('profile',$profile)->with('advisor_name',$advisor_name)->with('sub_value',$sub_value)->with('total',$total)->with('error',$error)->with('secname',$user_section)->with('session',$active_session)->with('paid',$paid);
            }
            else
            {
