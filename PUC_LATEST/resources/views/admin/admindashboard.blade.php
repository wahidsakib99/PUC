    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="flex-items container">
                <div id="firstitem" class=" bg-primary text-white items card shadow">
                    <h5>Total Student</h5>
                    <h6 id="total_student">0</h6>
                </div>
                <div id="seconditem" class=" bg-danger text-white items card shadow">
                    <h5>Session</h5>
                    <h6 id="session"></h6>
                </div>
                <div id="thirditem" class="shadow  bg-dark text-white card items hoverable">
                    <h5></h5>
                    <h6></h6>
                </div>
            </div>
 ...
 function update_prereq(id,type)
 {
    ...
    $.ajax({
        ...
        {  
            ...
            document.getElementById('hidsem').value = data['selected_semester'].name;
            if(type === 0)
            {
