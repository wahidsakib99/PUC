                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you
                                sure you want to delete <strong id="subjectname"></strong>
                            </div>
        ...
        $.ajax(
            {
                ...
                success:function(data)
                {
                    ...
                    if(data['nodata'] === false)
                    {
                        ...
                        {
                            tabledata =tabledata+ "<tr><td>"+subjects[i].name+"</td><td>"+subjects[i].code+"</td><td>"+subjects[i].credit+"</td><td><button type='button' class='btn btn-secondary' onclick='updatemodal("+subjects[i].id+")'>Update</button></td><td><button type='button' class='btn btn-danger' onclick='deletemodal("+subjects[i].id+")'>Delete</button></td></tr>"
                        }
