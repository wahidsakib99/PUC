...
<div class="container">
    ...
    <div class="tab-content">
        ...
        <div id="subject" class="tab-pane fade" style="background: #fff">
            <!-- Body of section and advisor set -->
            <div class="table-responsive" style="overflow-y:auto; max-height: 73%;">
                <table class="table assignteachertable  table-sm text-center" id="assignteacherndata">
                    <thead>
                        <tr class="table-success">
                            <th>Check</th>
                            <th>Subject</th>
        ...
        <div id="update" class="tab-pane fade" style="background: #fff">
            <!-- Body of section and advisor set -->
            <div class="table-responsive" style="overflow-y:auto; max-height: 73%">
                <table class="table table-sm text-center" id="updateassignedteacher">
                    <thead>
        ...
        <div id="update_advisor" class="tab-pane fade" style="background: #fff">
            <!-- Body of section and advisor set -->
            <div class="table-responsive" style="overflow-y:auto; max-height: 73%">
                <table class="table table-sm text-center" id="updateassignedadvisor">
                    <thead>
                        <tr class="table-info">
                            <th><input type="checkbox"></th>
                            <th>Section</th>
            ...
            if (data['nosession'] === false) {
                ...
                if (data['nodata'] === false) {
                    for (var i = 0; i < data['data'].length; i++) {
                        tablerow_start = "<tr><td><input type='checkbox' name='updatesectionadvisor[]' value=" + all_data[i].id + "></td><td>" + all_data[i].secname + "</td><td>" + all_data[i].advisorname + "</td><td><select class='" + all_data[i].id + " form-control form-control-sm'>";
